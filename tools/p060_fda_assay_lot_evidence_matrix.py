    ...
    checks = [
        ...
        check(
            ...
            contains_all(
                ...
                [
                    ...
                    "all the nominated off-target edit sites is recommended",
        ...
        check(
            ...
            contains_all(
                prior_pdf,
                [
                    "support a lot release specification",
                    "similarity(s) of the GE component or product structure",
        ...
        check(
            ...
            contains_all(
                prior_pdf,
                [
                    "real time stability data of primary product lots",
        ...
        check(
            ...
            contains_all(
                prior_pdf,
                [
                    "impact of product differences on a comparability determination",
        ...
        check(
            ...
            contains_all(
                ...
                [
                    ...
                    "study design(s), methods, analysis tools, and sequencing technologies",
                    "may be more broadly appropriate",
