...
Current state: **stage 1o evidence hardening; B2 now has a posterior-weighted decoder-risk ledger, B6 has a structural/electronic proxy boundary, and B10 remains a denominator-boundary track**.
...
| B2 | Low-overhead QEC | Stim baseline plus closed reduced-round artifact boundary; T-B2-004 Stim HERALDED_ERASE / DEPOLARIZE1 stress found 10 d=5/d=7 improved rows; T-B2-005 false-positive stress found 5 positive-false-positive d=5/d=7 improved rows at fp=0.001/tick but 0 improved rows by fp=0.003/tick; T-B2-006 posterior-calibrated boundary had 6 raw profile-survivor rows; T-B2-007 posterior-weighted decoder-risk ledger evaluates 4 risk budgets / 4608 budget-profile rows and leaves mild/nominal/conservative/strict adjusted survivors at 6/5/3/3, with strict high-purity survivors 0 and no robust all-profile adjusted survival. | Replace the risk ledger with a circuit-level shot-conditioned decoder or hardware-calibrated leakage/flag dataset that preserves d=5/d=7 target-volume rows under strict posterior, missed-leakage, noise-mismatch, and realistic false-positive gates. | Demote the leakage-erasure route if d=5/d=7 target-volume rows disappear under conservative/strict posterior-weighted risk, calibrated false-positive rates, missed-leakage bounds, or noise mismatch. |
...
| Week | Focus |
|---:|---|
| 1 | Freeze B1 proof-log report outline; B2 reduced-round is closed and T-B2-007 has a posterior-weighted risk ledger, so convert it into a circuit-level shot-conditioned decoder or calibrated leakage dataset; pair B4 and B8 into one verification lane. |
